...
(function(w){
var immersed = 0;
var sImmersed = localStorage.immersed;
if(!sImmersed&&sImmersed!==0){
...
immersed = parseInt(immersed);
dimmersed = immersed+45;
//immersed =50
if(!immersed){
	return;
}
var t=document.getElementById('header');
t&&(t.style.paddingTop=immersed+'px',t.style.background='-webkit-linear-gradient(top,rgba(51,204,204,1),rgba(51,204,204,0.8))',t.style.height=immersed+45+'px');

t=document.getElementById('content');
t&&(t.style.marginTop=immersed+'px');
t=document.getElementById('dcontent');
t&&(t.style.marginTop=dimmersed+'px');
